...
ALGOS=(
    ...
    LWC_SPARKLE_AEAD192 LWC_SPARKLE_HASHXOF LWC_XOODYAK_HASH
...
COMBOS["flexwing2"]="FLEXWING2+PQM4_KYBER512+X25519+LWC_ASCON_HASHXOF+LWC_ASCON128_AEAD"
COMBOS["flexwing3"]="FLEXWING3+PQM4_KYBER512+X25519+LWC_SPARKLE_HASHXOF+LWC_SPARKLE_AEAD128"
